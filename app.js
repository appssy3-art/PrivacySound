...
const I18N = {
  ko: {
    ...
    donationThankYou: "당신의 따뜻한 마음이 이 서비스를 지켜나가는 힘이 됩니다.<br>진심으로 감사드려요.",
    laterBtn: "나중에 할게요",
  ...
  en: {
    ...
    donationThankYou: "Your warm heart is the power that keeps this service going.<br>We sincerely thank you!",
    laterBtn: "Later",
  ...
  ja: {
    ...
    donationThankYou: "あなたの温かい気持ちがサービスを続ける力になります。<br>心より感謝いたします。",
    laterBtn: "あとで",
  ...
  zh: {
    ...
    donationThankYou: "您的温暖支持是维持本服务运营的力量。<br>衷心感谢您！",
    laterBtn: "稍后再说",
  ...
  es: {
    ...
    donationThankYou: "Tu apoio es la força que mantiene este servicio.<br>¡Gracias de todo coração!",
    laterBtn: "Más tarde",
  ...
  pt: {
    ...
    donationThankYou: "Seu apoio é a força que mantém este serviço funcionando.<br>Nosso muito obrigado!",
    laterBtn: "Mais tarde",
  ...
  de: {
    ...
    donationThankYou: "Deine Unterstützung hält diesen Dienst am Leben.<br>Herzlichen Dank!",
    laterBtn: "Später",
  ...
  fr: {
    ...
    donationThankYou: "Votre soutien permet de maintenir ce service.<br>Merci du fond du cœur !",
    laterBtn: "Plus tard",
  ...
  vi: {
    ...
    donationThankYou: "Tấm lòng của bạn là động lực duy trì dịch vụ này.<br>Chân thành cảm ơn!",
    laterBtn: "Để sau",
  ...
  id: {
    ...
    donationThankYou: "Dukungan hangat Anda adalah energi untuk menjaga layanan ini.<br>Terima kasih tulus!",
    laterBtn: "Nanti",
  ...
  th: {
    ...
    donationThankYou: "กำลังใจของคุณคือแรงขับเคลื่อนบริการนี้<br>ขอบพระคุณจากใจจริง!",
    laterBtn: "ไว้ทีหลัง",
  ...
  ar: {
    ...
    donationThankYou: "دعمك الدافئ هو القوة التي تحافظ на هذه الخدمة.<br>شكراً جزيلاً!",
    laterBtn: "لاحقاً",
  ...
  ru: {
    ...
    donationThankYou: "Ваша поддержка — сила, поддерживающая этот сервис.<br>Огромное спасибо!",
    laterBtn: "Позже",
  ...
  hi: {
    ...
    donationThankYou: "आपका समर्थन ही इस सेवा को जारी रखने की ताकत है।<br>हार्दिक धन्यवाद!",
    laterBtn: "बाद में",
  ...
  la: {
    ...
    donationThankYou: "Animus tuus benignus est vis quae hoc servitium conservat.<br>Gratias maximas agimus!",
    laterBtn: "Postea",
